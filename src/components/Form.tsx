...
const Form = ({displayResult,setDisplayResult} : AppProps) =>{
    ...
    return (
    <div className="lg:w-1/4 w-11/12 m-auto bg-gray-800 shadow-2xl rounded-lg overflow-hidden">
        ...
        <Header />
            <input type={'text'} className="outline-none bg-transparent placeholder:text-gray-500 text-gray-500 border-2 border-gray-500 rounded my-2 mx-auto p-2" placeholder="City, Country" onChange={(e) => setQuery(e.target.value)} />
